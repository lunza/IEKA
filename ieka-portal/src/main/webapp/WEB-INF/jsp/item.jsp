...
<div class="w">
	<div class="breadcrumb">
		<strong><a href="http://channel.jd.com/electronic.html">类目1</a></strong><span>&nbsp;&gt;&nbsp;<a href="http://channel.jd.com/737-794.html" >类目11</a>&nbsp;&gt;&nbsp;<a href="http://list.jd.com/737-794-798.html" >类目111</a>&nbsp;&gt;&nbsp;</span><script type="text/javascript">pageConfig.product.cat=[737,794,798];</script><span><a href="http://www.jd.com/pinpai/798-20710.html" >类目1111</a>&nbsp;&gt;&nbsp;<a href="http://item.jd.com/1221882.html" >数据1</a></span>
	</div>
</div><!--breadcrumb end-->
<div class="w">
...
<div class="w">
	...
	<li clstag="shangpin|keycount|product|zhinan" data-widget='tab-item'><a href='javascript:;'>京博士</a></li>
			...
			<div class="mc" data-widget="tab-content" id="product-detail-1">
				<ul class="detail-list">
					<li title="长虹LED42538ES">名称：cat</li>
					<li>编号：100</li>
					<li>品牌：<a href="http://www.jd.com/pinpai/798-20710.html" target="_blank">aaa</a></li>
					<li>上架时间：2017-03-13 15:45:26</li>
					<li>颜色：黄</li>
					<li>产地：中国大陆</li>
										<li>aaaa</li><li>aaaa</li><li>aaaa</li><li>aaaa</li><li>aaaa</li><li>aaaa</li>
				</ul>
	...
	宜家医向您保证所售商品均为正品行货<a href="http://www.jd.com/help/kdexpress.aspx" target="_blank">运费政策</a>，请您放心购买！
	<br /><br />
	注：信息信息信息
</div>
<div id="state">
	<strong>权利声明：</strong><br />法律可行性
	<p><b>注：</b>责任声明:xxxxxxx</p>
</div>
